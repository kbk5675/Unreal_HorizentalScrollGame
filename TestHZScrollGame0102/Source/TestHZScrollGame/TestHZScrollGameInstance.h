...
public:
	...
	TArray<FString> GetTPlayerName() { return TPlayerNames; }
	void AddTPlayerName(const FString& Name) { TPlayerNames.Add(Name); }
	void ResetTPlayerNames() { TPlayerNames.Empty(); }

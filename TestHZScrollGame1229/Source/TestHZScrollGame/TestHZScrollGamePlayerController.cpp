...
void ATestHZScrollGamePlayerController::ServerApplyName_Implementation()
{
	MulticastApplyName();
}

void ATestHZScrollGamePlayerController::ClientApplyName_Implementation()
{
	MulticastApplyName();
}

void ATestHZScrollGamePlayerController::MulticastApplyName_Implementation()
{
	auto HZCharacter = Cast<ATestHZScrollGameCharacter>(this->GetPawn());
	HZCharacter->ApplyName(this->PlayerState->GetPlayerName());
}
